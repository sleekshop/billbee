<?php
/*
 * This is the configuration - file which has to be filled correctly in order to make this running properly
 */

//Sleekshop - credentials needed
...
//The key for authenticating the billbee - app
